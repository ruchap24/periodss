...
export default function LandingPage() {
  ...
  return (
    ...
    <div className={`relative transition-colors duration-300 ${
      ...
      {/* Navbar */}
      <nav className={`fixed w-full z-50 ${darkMode
        ? "backdrop-blur-md "
        ...
        <div className="container mx-auto px-2 py-6 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-6">
            ...
            <Button
              ...
              variant="ghost"
              className={`${darkMode ? "text-white hover:text-pink-200" : "text-purple-700 hover:text-purple-900"
                } hidden md:block`}
            >
              Features
            </Button>

            <Button className={`rounded-full px-6 py-2 ${darkMode
      ...
      {/* Hero Section */}
      <section className="pt-60 pb-20 relative overflow-hidden w-full">
        ...
        <motion.h2
          ...
          className={`text-4xl md:text-5xl font-bold mb-3 ${darkMode ? 'text-white' : 'text-gray-900'
            }`}
        >

          <div className="container mx-auto px-4 relative z-10 ">
            <div className={`max-w-full mx-auto text-center transition-all duration-1000 ${isVisible ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-10"
              }`}>
              <div className="mb-10">
                <span className={`inline-block px-4 py-2 rounded-full text-sm font-medium ${darkMode
              ...
              <h1 className={`text-5xl md:text-7xl font-bold mb-6 leading-tight ${darkMode ? "text-white" : "text-purple-900"
                }`}>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-6 mt-24 mb-16">
                <Button className={`group rounded-full px-8 py-6 text-lg font-semibold ${darkMode
                ...
                <Button
                  variant="outline"
                  onClick={() => scrollToSection('features')}
                  className={`rounded-full px-8 py-6 text-lg font-semibold ${darkMode
      ...
      <section id="features" className={`py-40`}>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className={`text-xl ${darkMode ? "text-white/70" : "text-purple-700"
              }`}>
            ...
            {[
              ...
              >
                <CardContent className="p-0">
                  ...
                  <p className={`leading-relaxed ${darkMode ? "text-pink-100/70" : "text-purple-700"
                    }`}>
                    {feature.description}
                  </p>
                </CardContent>
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={index} className="group">
                <div className={`text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r ${darkMode
                  ? "from-pink-700 to-purple-500"
                  : "from-pink-600 to-purple-600"
                  } bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300`}>
                  {stat.number}
                </div>
                <div className={`text-lg ${darkMode ? "text-white-100/70" : "text-purple-700"
                  }`}>
                  {stat.label}
                </div>
              </div>
      ...
      {/* CTA Section */}
      <section className={`py-20 ${darkMode ? "bg-[#020617]" : "bg-pink-50"
        }`}>
        <div className="container mx-auto px-6 text-center">
          ...
          <p className={`text-xl mb-10 ${darkMode ? "text-pink-100/80" : "text-purple-700"
            }`}>
      ...
      {/* Footer */}
      <footer className={`py-12 ${darkMode ? "bg-[#020617]" : "bg-pink-50"
        } text-white`}>
        <div className="container mx-auto px-6">
